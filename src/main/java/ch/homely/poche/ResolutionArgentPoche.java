...
public record ResolutionArgentPoche(
    ...
    public static ResolutionArgentPoche aucune(double rav) {
        return new ResolutionArgentPoche(0.0, SourceArgentPoche.AUCUNE, null, null, rav);
    }

    public static ResolutionArgentPoche parAllocation(double montant, UUID allocationId, double rav) {
        return new ResolutionArgentPoche(montant, SourceArgentPoche.ALLOCATION, null, allocationId, rav);
    }

    public static ResolutionArgentPoche parPolitique(double montant, UUID politiqueId, double rav) {
        return new ResolutionArgentPoche(montant, SourceArgentPoche.POLITIQUE, politiqueId, null, rav);
    }
}
